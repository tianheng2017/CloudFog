...
.c-side { width: 220px; flex: none; border-right: 1px solid var(--cf-line); display: flex; flex-direction: column; padding: 20px 12px; gap: 20px; background: var(--cf-surface); }
...
.c-body { flex: 1; min-width: 0; padding: 28px 32px; }
</style>
